	...
	public class WebCamCapture : System.Windows.Forms.UserControl
	{
		...
		*/
		...
		public void Start(ulong FrameNum)
		{
			...
			{ 
				Console.WriteLine("Error 2 An error ocurred while starting the video capture. Check that your webcamera is connected properly and turned on.\r\n\n" + excep.Message);
                this.Start(this.FrameNumber);
                //this.Stop();
			}
		}
		...
		public void Stop()
		{
			...
			{ // don't raise an error here.
              Console.WriteLine("Error3 An error ocurred while capturing the video image.\n" + excep.Message);
              //this.Start(this.FrameNumber);
			}
		...
		private void timer1_Tick(object sender, System.EventArgs e)
		{
			...
			{ 
				Console.WriteLine("Error1 An error ocurred while capturing the video image.\n" + excep.Message);
                this.Start(this.FrameNumber);
